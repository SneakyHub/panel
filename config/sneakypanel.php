...
return [
    ...
    */
    ...
    | standard sneakypanel shipped services.
    */
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('sneakypanel_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('sneakypanel_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('sneakypanel_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('sneakypanel_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('sneakypanel_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('sneakypanel_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('sneakypanel_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('sneakypanel_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('sneakypanel_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('sneakypanel_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by sneakypanel.
    */

    'telemetry' => [
        'enabled' => env('sneakypanel_TELEMETRY_ENABLED', true),
    ],
];
