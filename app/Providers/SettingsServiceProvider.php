...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'sneakypanel:guzzle:timeout',
        'sneakypanel:guzzle:connect_timeout',
        'sneakypanel:console:count',
        'sneakypanel:console:frequency',
        'sneakypanel:auth:2fa_required',
        'sneakypanel:client_features:allocations:enabled',
