...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('sneakypanel.client_features.allocations.enabled')) {
    ...
    {
        $start = config('sneakypanel.client_features.allocations.range_start', null);
        $end = config('sneakypanel.client_features.allocations.range_end', null);
