...
namespace sneakypanel\Extensions\Spatie\Fractalistic;
...
use sneakypanel\Extensions\League\Fractal\Serializers\sneakypanelSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new sneakypanelSerializer();
        }
