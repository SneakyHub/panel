...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for sneakypanel.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="sneakypanel:guzzle:connect_timeout" value="{{ old('sneakypanel:guzzle:connect_timeout', config('sneakypanel.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="sneakypanel:guzzle:timeout" value="{{ old('sneakypanel:guzzle:timeout', config('sneakypanel.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="sneakypanel:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('sneakypanel:client_features:allocations:enabled', config('sneakypanel.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="sneakypanel:client_features:allocations:range_start" value="{{ old('sneakypanel:client_features:allocations:range_start', config('sneakypanel.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="sneakypanel:client_features:allocations:range_end" value="{{ old('sneakypanel:client_features:allocations:range_end', config('sneakypanel.client_features.allocations.range_end')) }}">
