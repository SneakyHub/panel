...
namespace sneakypanel\Tests\Integration\Services\Databases;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('sneakypanel.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('sneakypanel.client_features.databases.allow_random', false);
