...
namespace sneakypanel\Tests\Integration\Api\Application;
...
use sneakypanel\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.sneakypanel.v1+json')
