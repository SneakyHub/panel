# Local Development
sneakypanel is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of sneakypanel will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get sneakypanel assets building. After that, its as
...
the asset URLs used in sneakypanel.

#### Development Environment
If you're using the [`sneakypanel/development`](https://github.com/sneakypanel/development) environments, which are
